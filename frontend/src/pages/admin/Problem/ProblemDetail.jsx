    ...
    <main className="w-full flex-grow p-6">
      ...
      <div className="grid grid-cols-2 grid-rows-1 gap-4">
        ...
        <div className="flex flex-row justify-between mb-4">
          ...
          <textarea className="w-60 h-20 px-1 border"></textarea>
        </div>
        <div className="flex flex-row justify-between mb-4">
        ...
        <div className="flex flex-row justify-between mb-4">
          ...
          <input type="number" className="w-60 pl-2 h-8 border" />
        </div>
        <div className="space-x-[323px] flex flex-row mb-5">
          <div className="text-xl">Public</div>
          <input className="border w-4 " type="checkbox" />
        </div>
        <div className="flex flex-row justify-between mb-4">
          <div className="text-xl">Level</div>
          <select className="w-44 border">
            <option>Easy</option>
